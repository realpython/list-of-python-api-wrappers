...
### [Spurwing Scheduling API](https://www.spurwing.io/) - Enterprise Scheduling & Booking
- [API Documentation](https://docs.spurwing.io/)
- [Python wrapper for Scheduling API](https://github.com/Spurwing/Spurwing-API-Python-Library)
